<template>
  <div class="comp-full-calendar">
    <div class="full-box-title">
      <div class="month"><span class="number">{{currentDate.getMonth() + 1}}</span> 月
      </div>
      <div class="year "
        v-if="idx === 0 || currentDate.getMonth() === 0"><span class="number-year">{{currentDate.getFullYear()}}</span> 年</div>
    </div>
    <fc-body :current-date="currentDate"
      :events="events"
